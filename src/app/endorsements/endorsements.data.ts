...
export const CANDIDATES: CandidateConfig[] = [
...

    {
        ...
        state: 'Florida',
        electionStatus: 'Lost Primary',
        jurisdiction: 'Congressional District 25',
...

    {
        ...
        state: 'Oklahoma',
        electionStatus: 'Won Primary',
        jurisdiction: 'Senate District 12',
...

    {
        ...
        state: 'Texas',
        electionStatus: 'Elected',
        jurisdiction: 'Senate District 9',
        ...
        websiteHref: 'https://www.taylorfortx.com/',
        donateHref: 'https://secure.actblue.com/donate/taylor-rehmet-1',
        initiativeType: 'state',
...

    {
        ...
        websiteHref: 'https://www.bradlanderforcongress.com/',
        donateHref: 'https://secure.actblue.com/donate/bl4cweb',
        initiativeType: '',
...

    {
        ...
        state: 'California',
        electionStatus: 'Won Primary',
        jurisdiction: 'Congressional District 17',
        primaryElection: new Date('06/02/26'),
        generalElection: new Date('11/03/26'),
        incumbent: true,
        ...
        websiteHref: 'https://www.rokhanna.com',
        donateHref: 'https://www.rokhanna.com/contribute',
        initiativeType: '',
...

    {
        ...
        websiteHref: 'https://jamestalarico.com/',
        donateHref:
            'https://secure.actblue.com/donate/jt-tx-web?refcode=web-ftr',
        initiativeType: 'national',
...

    {
        ...
        state: 'Texas',
        electionStatus: 'Lost Primary',
        jurisdiction: 'Congressional District 33',
        primaryElection: new Date('03/03/26'),
        generalElection: new Date('11/03/26'),
...

    {
        ...
        state: 'Michigan',
        electionStatus: 'Dropped Out',
        jurisdiction: 'Legislative District 92',
        primaryElection: new Date('08/04/26'),
        generalElection: new Date('11/03/26'),
...

    {
        ...
        state: 'New York',
        electionStatus: 'Won Primary',
        jurisdiction: 'Legislative District 149',
        primaryElection: new Date('06/23/26'),
        generalElection: new Date('11/03/26'),
...

    {
        ...
        state: 'Texas',
        electionStatus: 'Won Primary',
        jurisdiction: 'Congressional District 35',
        primaryElection: new Date('03/03/26'),
        generalElection: new Date('11/03/26'),
        incumbent: true,
        ...
        websiteHref: 'https://www.casarforcongress.com',
        donateHref: 'https://secure.actblue.com/donate/gc-web?refcode=header',
        initiativeType: '',
...

    {
        ...
        state: 'Maryland',
        electionStatus: 'Lost Primary',
        jurisdiction: 'Montgomery County Council At-Large',
        primaryElection: new Date('06/23/26'),
        generalElection: new Date('11/03/26'),
        handle: 'josieformd',
...

    {
        ...
        bodyText:
            'represents the best that New Jersey has to offer. She is a bold fighter for her community and a passionate advocate for change',
...

    {
        ...
        bodyText: 'https://secure.actblue.com/donate/robert-arnold',
        image: '/images/endorsement_images/2026/Silhouette/Robert Arnold.png',
        websiteHref: 'https://www.arnoldforsd.com/',
        donateHref: '',
        initiativeType: 'state',
...

    {
        ...
        donateHref: 'https://jacksonfranklinforcongress.com/donors',
        initiativeType: 'national',
...

    {
        ...
        state: 'Maryland',
        electionStatus: 'Lost Primary',
        jurisdiction: 'Legislative District 9B',
        primaryElection: new Date('06/23/26'),
        generalElection: new Date('11/03/26'),
        handle: 'votematin9b',
...

    {
        ...
        state: 'California',
        electionStatus: 'Lost Primary',
        jurisdiction: 'Congressional District 48',
        primaryElection: new Date('06/02/26'),
        generalElection: new Date('11/03/26'),
...

    {
        ...
        state: 'New Jersey',
        electionStatus: 'Won Primary',
        jurisdiction: 'Congressional District 12',
        primaryElection: new Date('06/02/26'),
        generalElection: new Date('11/03/26'),
        handle: 'HamawyForNJ',
...

    {
        ...
        state: 'New Jersey',
        electionStatus: 'Lost Primary',
        jurisdiction: 'Passaic County Commissioner',
        primaryElection: new Date('06/02/26'),
        generalElection: new Date('11/03/26'),
...

    {
        ...
        generalElection: new Date('11/03/26'),
        handle: 'RepRabb',
        handleHref: 'https://x.com/RepRabb',
        bodyText: '',
        image: '/images/endorsement_images/2026/Silhouette/Chris Rabb.png',
        websiteHref: 'https://www.chrisrabb.com',
        donateHref: 'https://secure.actblue.com/donate/rabbwebsite',
        initiativeType: 'state',
        endorsementType: 'PV Pledge',
        showPvMember: false,
        avatarBackgroundColor: 'yellow',
...

    {
        ...
        generalElection: new Date('11/03/26'),
        handle: 'Booker4KY',
        handleHref: 'https://x.com/Booker4KY/',
        bodyText: '',
        image: '/images/endorsement_images/2026/Silhouette/Charles Booker.png',
        websiteHref: 'https://charlesbooker.org/',
        donateHref:
            'https://secure.actblue.com/donate/booker-for-senate?refcode=web-donate-bar',
        initiativeType: 'national',
        endorsementType: 'PV Pledge',
        showPvMember: false,
        avatarBackgroundColor: 'yellow',
...

    {
        ...
        state: 'New York',
        electionStatus: 'Won Primary',
        jurisdiction: 'Congressional District 13',
        primaryElection: new Date('06/23/26'),
        generalElection: new Date('11/03/26'),
...

    {
        ...
        primaryElection: new Date('03/17/26'),
        generalElection: new Date('11/03/26'),
        handle: 'demiforillinois.bsky.social',
        handleHref: 'https://bsky.app/profile/demiforillinois.bsky.social',
        bodyText: '',
        image: '/images/endorsement_images/2026/Silhouette/Demi Palecek.png',
        websiteHref: 'https://www.demiforillinois.com/',
        donateHref: 'https://secure.actblue.com/donate/demiforillinois',
        initiativeType: '',
        endorsementType: 'Endorsement',
        showPvMember: false,
        avatarBackgroundColor: 'blue',
...

    {
        ...
        generalElection: new Date('11/03/26'),
        handle: 'CMMaiVang',
        handleHref: 'https://x.com/CMMaiVang',
        bodyText: '',
        image: '/images/endorsement_images/2026/Silhouette/Mai Vang.png',
        websiteHref: 'https://www.maiforus.com',
        donateHref:
            'https://secure.numero.ai/contribute/Mai-Vang-for-Congress?refcode=webpopup',
        initiativeType: '',
        endorsementType: 'PV Pledge',
        showPvMember: false,
        avatarBackgroundColor: 'blue',
...

    {
        ...
        state: 'New York',
        electionStatus: 'Lost Primary',
        jurisdiction: 'Senate District 23',
        primaryElection: new Date('06/23/26'),
        generalElection: new Date('11/03/26'),
        handle: 'OmarFMohamad',
...

    {
        ...
        primaryElection: new Date('06/02/26'),
        generalElection: new Date('11/03/26'),
        handle: 'RosePenelopeYee',
        handleHref: 'https://x.com/RosePenelopeYee',
        bodyText: '',
        image: '/images/endorsement_images/2026/Silhouette/Rose Penelope Yee.png',
        websiteHref: 'https://roseforcongress.com',
        donateHref:
            'https://secure.actblue.com/donate/people-peace-planet?refcode=website',
        initiativeType: '',
        endorsementType: 'Endorsement',
        showPvMember: false,
        avatarBackgroundColor: 'blue',
...

    {
        ...
        state: 'New York',
        electionStatus: 'Lost Primary',
        jurisdiction: 'Onondaga County Legislature District 8',
        primaryElection: new Date('06/23/26'),
        generalElection: new Date('11/03/26'),
...

    {
        ...
        state: 'California',
        electionStatus: 'Won Primary',
        jurisdiction: 'Congressional District 23',
        primaryElection: new Date('06/02/26'),
        generalElection: new Date('11/03/26'),
        handle: 'tessaforca',
        handleHref: 'https://x.com/tessaforca',
        bodyText: '',
        image: '/images/endorsement_images/2026/Silhouette/Tessa Lynn Hodge.png',
        websiteHref: 'https://www.taylorfortx.com/',
        donateHref:
            'https://www.taylorfortx.com/	https://secure.actblue.com/donate/taylor-rehmet-1',
        initiativeType: '',
        endorsementType: 'Endorsement',
        showPvMember: true,
        avatarBackgroundColor: 'blue',
    ...
    },
    {
        ...
        state: 'Florida',
        electionStatus: 'Lost Primary',
        jurisdiction: 'Congressional District 21',
        primaryElection: new Date('08/18/26'),
        generalElection: new Date('11/03/26'),
    ...
    },
    {
        ...
        state: 'Florida',
        electionStatus: 'Lost Primary',
        jurisdiction: 'Congressional District 20',
        primaryElection: new Date('08/18/26'),
        generalElection: new Date('11/03/26'),
        handle: 'VoteManley',
    ...
    },
    {
        ...
        state: 'Florida',
        electionStatus: 'Won Primary',
        jurisdiction: 'Congressional District 26',
        primaryElection: new Date('08/18/26'),
        generalElection: new Date('11/03/26'),
        handle: 'locklin2026',
    ...
    },
    {
        ...
        state: 'Florida',
        electionStatus: 'Won Primary',
        jurisdiction: 'Tallahassee City Commissioner',
        primaryElection: new Date('08/18/26'),
        generalElection: new Date('11/03/26'),
        handle: 'pjfortally',
    ...
    {
        id: '108',
        name: 'Hannah Sabio-Howell',
        state: 'Washington',
        electionStatus: 'Won Primary',
        jurisdiction: 'Senate District 43',
        primaryElection: new Date('08/04/26'),
        generalElection: new Date('11/03/26'),
        handle: 'hannahsabiohowell.bsky.social',
        handleHref: 'https://bsky.app/profile/hannahsabiohowell.bsky.social',
        bodyText: '',
        image: '/images/endorsement_images/2026/Silhouette/Hannah Sabio-Howell.png',
        websiteHref: 'https://hannahforwashington.com/',
        donateHref: 'https://secure.ngpvan.com/RJZMkidjvU6oUenfhNSsWg2',
        initiativeType: 'state',
